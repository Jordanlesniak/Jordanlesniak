...
"""
This module imports constants from astropy.constants and stores them
as usable variables.
"""
...
pi = _ac.pi
K_e = (1/5) * (3/(8*pi))**(2/3) * h**2/m_e * (1/(2*m_u))**(5/3) 

# add here any other constants you wish to include
